...
**Prime:** read [prime.md](prime.md). Claude session binding and Stop-hook behavior
below describe retained upstream compatibility code, not an active Prime workflow.
Do not use `--bind` or configure a hook in Prime. The installer always refuses.
