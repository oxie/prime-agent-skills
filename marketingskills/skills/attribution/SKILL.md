...
- **Ad-platform pixels, CAPI, server-side conversion tracking** → **ads** ([conversion-tracking.md](../ads/references/conversion-tracking.md)). Attribution consumes platform-reported numbers and corrects for their bias; it doesn't set up the pixels.
...
- **ads** — ad-platform pixels, CAPI, server-side conversion tracking ([conversion-tracking.md](../ads/references/conversion-tracking.md)).
