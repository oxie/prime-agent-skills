...
const read=p=>p==='hallmark/SKILL.md'?beforeStorefrontSkill(root,'hallmark'):p==='marketingskills/skills/image/SKILL.md'?beforeRampstackSkill(root,'marketingskills/skills/image'):readFileSync(resolve(root,p));
