import {beforeImg2threejsFile} from './img2threejs-snapshot.mjs';
...
export function previousMengtoSkill(skills,owner){
 ...
 const b=['hallmark','cinematic-ui'].includes(owner) ? beforeTasteSkill(skills,owner) : beforeImg2threejsFile(skills,owner+'/SKILL.md');
