...
| `engineering-references` | On-demand reference checklists for production reliability, data consistency and safe legacy changes; not global coding rules. | [ciembor/agent-rules-books](https://github.com/ciembor/agent-rules-books) @ `893a88a` (three selected mini references) |
