...
2. Pull stargazers (or forks for stronger intent) through an approved GitHub connection, then enrich company data only when authorized. See the [GitHub integration guide](../../../tools/integrations/github.md).
