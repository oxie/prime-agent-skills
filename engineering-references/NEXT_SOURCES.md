...
### [references/api-authorization.md](references/api-authorization.md)

- [skills/api-security-best-practices/SKILL.md](https://github.com/sickn33/agentic-awesome-skills/blob/bdfbf79ccaabdc31f60ce60ef1703a9abe95f9c3/skills/api-security-best-practices/SKILL.md)

### [references/sql-diagnosis.md](references/sql-diagnosis.md)

- [skills/sql-optimization-patterns/SKILL.md](https://github.com/sickn33/agentic-awesome-skills/blob/bdfbf79ccaabdc31f60ce60ef1703a9abe95f9c3/skills/sql-optimization-patterns/SKILL.md)
- [skills/sql-optimization-patterns/resources/implementation-playbook.md](https://github.com/sickn33/agentic-awesome-skills/blob/bdfbf79ccaabdc31f60ce60ef1703a9abe95f9c3/skills/sql-optimization-patterns/resources/implementation-playbook.md)
...
API guidance retains the existing provider and parsed allowlist, couples
object/tenant/operation authorization with the action, and tests denied writes
and relevant effects. SQL guidance preserves multiplicity/order/empty parents,
stable cursor semantics and measured workload equivalence. It rejects automatic
infrastructure, production probes and rollback-as-universal-protection claims.
No upstream JWT service, SQL optimizer or database scripts are bundled.
