import {beforeImg2threejsFile} from './helpers/img2threejs-snapshot.mjs';
...
const read=p=>p.endsWith('/SKILL.md') && Object.hasOwn(tasteRoutes,p.slice(0,-9)) ? beforeTasteSkill(root,p.slice(0,-9)) : beforeImg2threejsFile(root,p);
