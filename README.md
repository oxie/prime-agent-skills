...
| `engineering-references` | On-demand reliability, data/response/mutation contracts, release dependencies and safe legacy changes; not global coding rules. | Three [agent-rules-books](https://github.com/ciembor/agent-rules-books) minis plus [selected corrected core](engineering-references/THIRD_PARTY.md) |
