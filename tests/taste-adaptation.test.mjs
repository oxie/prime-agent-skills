...
import {beforeRampstackSkill} from './helpers/rampstack-snapshot.mjs';
...
const read=p=>p==='hallmark/SKILL.md'?beforeStorefrontSkill(root,'hallmark'):p==='marketingskills/skills/image/SKILL.md'?beforeRampstackSkill(root,'marketingskills/skills/image'):p.startsWith('cinematic-ui/')?beforeHiggsfieldFile(root,p):readFileSync(resolve(root,p));
