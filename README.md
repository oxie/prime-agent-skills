...
| `hallmark` | Project-first visual design, app/mobile usability, scoped shadcn/localization guidance, audit and screenshot study; design guidance for Variate rounds. | [nutlope/hallmark](https://github.com/nutlope/hallmark) @ `13ac0ec` (curated Prime adaptation) |
...
| `ponytail` | On-demand minimal implementation, evidence-based complexity review/audit and shortcut-comment reports; no persistent mode or plugins. | [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) @ `356918e` (selective Prime adaptation) |
| `engineering-references` | On-demand reliability, data/response/mutation contracts, API authorization, result-preserving SQL diagnosis, release dependencies and safe legacy changes; not global coding rules. | Three [agent-rules-books](https://github.com/ciembor/agent-rules-books) minis plus [selected corrected core](engineering-references/THIRD_PARTY.md) |
