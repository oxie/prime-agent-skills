<!-- Prime: inspect destinations first; never overwrite unrelated plans/ledgers.
Require atomic artifacts, completed exits and independent parent verification.
See references/prime.md in the installed skill. -->
...
- Host launch mode: <Prime native RLM | declared sequential fallback>
