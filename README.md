...
| `code-review` | Requirements/correctness and project-standards review of the actual branch, staged or dirty-work snapshot, plus incoming-comment assessment; read-only by default. | [Matt Pocock source adaptation](code-review/UPSTREAM.md) |
...
| `task-observer` | Observation during user-started tool sessions. Learns from real work through Prime's continual harness and approved Git skill updates; no synthetic model trials by default. | [rebelytics/one-skill-to-rule-them-all](https://github.com/rebelytics/one-skill-to-rule-them-all) |
